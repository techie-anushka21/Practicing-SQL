--Creating our second table in SQL, will be moving to other concepts in upcoming programs.
--Also covered the following Common Mathematical Functions:-
--1. MAX() -> For maximum value.
--2. MIN() -> For minimum value.
--3. AVG() -> For average value.
--4. SUM() -> For sum (addition).
--5. COUNT() -> For totalling.
